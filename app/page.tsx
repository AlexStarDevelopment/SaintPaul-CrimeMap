      ...
      <div className="card w-96 bg-base-100 shadow-xl m-5">
        <div className="card-title">
          <p className="m-5">
            ...
            really buggy and hard to work with. I figured if I was having
            trouble navigating it, others would be too. That was the insperation
            behind building this app. I decided to start small with just my own
            neighborhood, The Westside! I have loved living here for the past 4
            years and have never had any serious run ins with crime. However, I
            like to stay informed! I assume you do too if you are reading this!
            This app is a proof of concept and if you like it and want to see me
            continue building it, please let me know. If you REALLY like it and
            want to buy me a cup of joe from Amore on Annapolis and Smith I have
            included a button above. Please do not feel obligated and only do so
            if you want and are able! THANK YOU!
          </p>
        </div>
      </div>
      <div className="card w-96 bg-base-100 shadow-xl m-5">
